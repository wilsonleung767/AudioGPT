...
import os
openai.api_key = "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"
...
chat = openai.ChatCompletion.create(
  ...
  messages=[
        ...
        {"role": "user", "content": f"Summerize the content of the podcast, list them in point form, keep it detailed and clear.This is the script of the podcast: {script_text}" }
    ]
)
